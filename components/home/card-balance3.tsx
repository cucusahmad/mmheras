      ...
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          ...
          <div className="flex flex-col">
            <span className="text-white">PT. Gumilang Jaya</span>
            <span className="text-white text-xs">7 Sensor</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div>
            ...
            <span className="text-white text-xs">Ph</span>
          </div>
          ...
          <div>
            ...
            <span className="text-white text-xs">Suhu</span>
          </div>
          ...
          <div>
            ...
            <span className="text-white text-xs">Hmdt</span>
          </div>
        </div>
      </CardBody>
    </Card>
