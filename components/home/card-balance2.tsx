      ...
      <CardBody className="py-5">
        <div className="flex gap-2.5">
          ...
          <div className="flex flex-col">
            <span className="text-default-900">IoT Kampus</span>
            <span className="text-default-900 text-xs">5 Sensor</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div>
            ...
            <span className="text-default-900 text-xs">Ph</span>
          </div>
          ...
          <div>
            ...
            <span className="text-default-900 text-xs">Suhu</span>
          </div>
          ...
          <div>
            ...
            <span className="text-default-900 text-xs">Hmdt</span>
          </div>
        </div>
      </CardBody>
    </Card>
